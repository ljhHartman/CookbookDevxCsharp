...
namespace CookbookDevxCsharp.lib.gridControl
{
    public partial class ucMasterDetail : UserControl
    {
        ...
        private void loadData()
        {
            ...
            lstCategories.Add(new Category() { KeytID = 1, Name = "Adventure" });
            lstCategories.Add(new Category() { KeytID = 2, Name = "Children" });
            lstCategories.Add(new Category() { KeytID = 3, Name = "Computer" });
